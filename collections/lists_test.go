...
func TestListProperties(t *testing.T) {
	tests := []struct {
		...
		{"circularArrayList1", NewCircularArrayList[int]()},
		{"circularArrayList2", NewCircularArrayListOfSize[int](0)},
		{"circularArrayList3", NewCircularArrayListOfEq[int](0, funcs.ValueEqual[int])},
